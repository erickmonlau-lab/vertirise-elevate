...
export function HeroCinematic() {
  ...
  return (
    <section 
      ...
      className="relative min-h-[100svh] flex items-center justify-center bg-[#02040a] overflow-hidden perspective-[1200px]"
    >
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-16 lg:gap-24 pt-20 pb-16">
        ...
        <div ref={leftColRef} className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start w-full">
          ...
          <h1 className="text-6xl md:text-7xl lg:text-[88px] font-extrabold text-white leading-[1.05] tracking-tight mb-8">
        ...
        <div 
          ref={rightColRef} 
          className="flex-1 w-full max-w-[500px] aspect-[4/5] relative rounded-[36px] overflow-hidden bg-[#040b14] border border-white/10 shadow-[inset_0_0_80px_rgba(0,150,255,0.05),0_30px_100px_-20px_rgba(0,0,0,0.8)] shrink-0 z-10 flex items-end justify-center transform-gpu"
        >
          ...
          <svg viewBox="0 0 400 500" className="w-full h-full relative z-20" preserveAspectRatio="xMidYMax meet">
            ...
            <g mask="url(#clean-mask)">
              <image href={buildingFacadeImg} width="400" height="500" preserveAspectRatio="xMidYMid slice" filter="brightness(1.1) saturate(1.2)" />
              <rect x="-400" y="-400" width="800" height="800" fill="url(#reflection-grad)" className="anim-reflection mix-blend-overlay" />
            </g>

            <g>
              <line x1="120" y1="-10" x2="120" y2="500" stroke="#1e293b" strokeWidth="1.5" opacity="0.6" />
              <line x1="280" y1="-10" x2="280" y2="500" stroke="#1e293b" strokeWidth="1.5" opacity="0.6" />
              ...
              <g className="anim-worker" style={{ transform: 'translateY(-10px)' }}>
