    ...
    <section className="py-24 lg:py-32 bg-[#D52374] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        <Reveal className="text-center mb-16">
          <span className="text-[13px] font-black tracking-[0.2em] uppercase text-[#0B2163]">
            {t("certs.badge")}
          </span>
            ...
            <Reveal key={c.name} delay={i * 80} className="h-full">
              <div className="p-6 lg:p-8 rounded-[24px] bg-white shadow-xl shadow-[#0B2163]/10 hover:-translate-y-2 transition-transform duration-300 h-full flex flex-col group">
                <div className="flex items-center gap-4 mb-5">
                  ...
                  <div className="text-xl font-extrabold text-[#0B2163] tracking-tight">
                    {c.name}
                  </div>
                </div>
                <div className="text-[15px] text-[#0B2163]/90 font-bold mb-2 leading-snug">
                  {c.desc}
                </div>
                <div className="text-[14px] text-[#0B2163]/70 leading-relaxed flex-1">
                  {c.detail}
                </div>
              </div>
            </Reveal>
            ...
            <div className="mt-10 space-y-4">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-white font-bold text-[clamp(11px,3.5vw,16px)] tracking-tight group-hover:text-electric transition-colors truncate">
