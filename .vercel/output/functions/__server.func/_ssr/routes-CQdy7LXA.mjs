...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CQdy7LXA.js
...
var sectors = [
	{
		...
		icon: "M3 21h18 M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16 M9 7h6 M9 11h6 M9 15h6"
	},
	{
		name: "Edificios Corporativos",
		icon: "M12 2v20 M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6 M6 5h1 M6 9h1 M6 13h1 M6 17h1 M17 9h1 M17 13h1 M17 17h1"
	},
	{
		name: "Hoteles",
		icon: "M3 21h18 M4 21V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v13 M8 10h.01 M12 10h.01 M16 10h.01 M8 14h.01 M12 14h.01 M16 14h.01 M8 18h.01 M12 18h.01 M16 18h.01"
	},
	{
	...
	},
	{
		...
		icon: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17M9 20a1 1 0 100-2 1 1 0 000 2zM18 20a1 1 0 100-2 1 1 0 000 2z"
	},
	{
		name: "Naves Industriales",
		icon: "M2 20h20 M4 20V8l4-4 4 4v12 M12 20V8l4-4 4 4v12 M9 20v-4h6v4"
	}
];
...
function Sectors() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "bg-[#0a1628] py-14 border-b border-white/5 overflow-hidden",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "max-w-7xl mx-auto px-6 lg:px-10",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "text-center mb-10",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-electric text-xs font-bold tracking-[0.25em] uppercase",
					children: "Especialistas en trabajos verticales para:"
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: sectors.map((sector, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "w-16 h-16 rounded-2xl bg-white/[0.04] border border-white/10 grid place-items-center mb-4 group-hover:bg-electric/10 group-hover:border-electric/30 transition-all duration-300",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
							width: "28",
							height: "28",
							viewBox: "0 0 24 24",
							...
							strokeLinecap: "round",
							strokeLinejoin: "round",
							className: "text-white/60 group-hover:text-electric transition-colors",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: sector.icon })
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						className: "text-white/80 font-bold text-sm tracking-wide leading-tight group-hover:text-white transition-colors",
