...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-TfFTXgbD.js
...
var process = [
	{
		n: "01",
		t: "Contacto inicial",
		d: "Atendemos su consulta y recopilamos los datos del inmueble para evaluar el tipo de intervención necesaria.",
	...
	},
	{
		n: "02",
		t: "Visita técnica",
		d: "Nos desplazamos sin coste para inspeccionar in situ los accesos, anclajes y posibles riesgos estructurales.",
		icon: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0Z M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"
	},
	{
		n: "03",
		t: "Propuesta detallada",
		d: "En menos de 24h entregamos un presupuesto cerrado con planificación temporal y plan de seguridad.",
		icon: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6"
	},
	{
		n: "04",
		t: "Ejecución",
		d: "Despliegue del equipo certificado IRATA ejecutando el trabajo bajo estricta coordinación técnica.",
		icon: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"
	},
	{
		n: "05",
		t: "Entrega y garantía",
		d: "Revisión final conjunta, emisión de certificados y garantía de resultado por escrito.",
		icon: "M9 12l2 2 4-4M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"
	}
];
var testimonials = [
...
function Nav() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: `fixed top-0 inset-x-0 z-50 transition-all duration-300 bg-white/95 backdrop-blur-xl border-b border-border ${scrolled ? "shadow-soft" : ""}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					className: "hidden md:flex items-center gap-9 text-sm font-bold text-navy",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `block w-5 h-0.5 rounded-full bg-navy transition-all duration-300 ${mobileOpen ? "rotate-45 translate-y-2" : ""}` }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `block w-5 h-0.5 rounded-full bg-navy transition-all duration-300 ${mobileOpen ? "opacity-0" : ""}` }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `block w-5 h-0.5 rounded-full bg-navy transition-all duration-300 ${mobileOpen ? "-rotate-45 -translate-y-2" : ""}` })
						]
					})]
				})
			...
			className: `md:hidden overflow-hidden transition-all duration-400 ease-in-out ${mobileOpen ? "max-h-80 border-t border-border bg-white" : "max-h-0 bg-white"}`,
...
function ClientLogos() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "bg-[#0a1628] py-10 border-b border-white/5 overflow-hidden",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "max-w-7xl mx-auto px-6 lg:px-10 mb-6",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-center text-white/30 text-xs font-bold tracking-[0.25em] uppercase",
				children: "Empresas, hoteles y comunidades que confían en DISET"
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "relative",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex animate-marquee-slow",
				children: doubled.map((logo, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "shrink-0 mx-8 flex items-center justify-center",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-white/20 font-black text-lg tracking-widest hover:text-white/40 transition-colors duration-500 cursor-default select-none whitespace-nowrap",
						children: logo.abbr
					})
				}, i))
			})
...
function VideoSection() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-0 right-1/4 w-[500px] h-[500px] rounded-full bg-electric/5 blur-[120px] pointer-events-none" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
				...
				children: process.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					delay: i * 80,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "h-full bg-mist rounded-2xl p-8 border border-border shadow-soft hover:shadow-elev hover:border-electric/40 transition-all group flex flex-col relative overflow-hidden",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "absolute -top-8 -right-4 text-[120px] font-black text-navy/[0.03] select-none pointer-events-none group-hover:text-electric/[0.05] transition-colors duration-500",
								children: p.n
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "w-14 h-14 rounded-xl bg-white border border-border group-hover:bg-electric group-hover:border-electric transition-colors grid place-items-center mb-6 shadow-sm",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
									width: "24",
									height: "24",
									viewBox: "0 0 24 24",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "text-2xl font-extrabold text-navy mb-3 group-hover:text-electric transition-colors relative z-10",
								children: p.t
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-base text-muted-foreground leading-relaxed flex-1 relative z-10",
								children: p.d
							})
						]
					})
...
function Coverage() {
	const [hoveredCity, setHoveredCity] = (0, import_react.useState)(null);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		id: "cobertura",
		className: "py-24 lg:py-32 bg-white",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [
				...
				delay: 120,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative bg-[#0a1628] rounded-[2rem] overflow-hidden border border-white/10 shadow-elev p-8 lg:p-12 h-full flex flex-col justify-center min-h-[450px]",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-white/40 text-xs font-bold uppercase tracking-widest mb-6 text-center",
							children: "Provincia de Barcelona"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "relative flex-1 w-full max-w-[400px] mx-auto",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
								viewBox: "0 0 500 500",
								className: "w-full h-full drop-shadow-[0_0_30px_rgba(0,150,255,0.1)]",
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
										d: "M140,160 Q180,240 250,290",
										fill: "none",
										stroke: "rgba(0,150,255,0.1)",
										strokeWidth: "1"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
										d: "M250,290 Q290,180 350,80",
										fill: "none",
										stroke: "rgba(0,150,255,0.1)",
										strokeWidth: "1"
									}),
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
													...
													r: isHovered ? 7 : 4,
													fill: "#0096FF",
													className: "transition-all duration-300 shadow-[0_0_15px_#0096FF]"
												}),
												...
												isHovered && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("text", {
													x: cx,
													y: cy - 5,
													textAnchor: "middle",
													...
													children: [city.projects, "+ proyectos"]
												})
											]
										}, city.name);
									})
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-8 flex items-center justify-center gap-2 text-white/30 text-xs font-semibold",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-2 h-2 rounded-full bg-electric animate-pulse shadow-[0_0_8px_#0096FF]" }), "Pasa el cursor sobre una ciudad"]
						})
					]
				})
			})]
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-5 text-white/50 max-w-xl mx-auto leading-relaxed",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						{
							label: "Protocolos IRATA",
							val: "Nivel internacional"
						},
						{
							label: "Formación continua",
							val: "Actualización anual"
						}
					].map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "p-4 rounded-xl bg-white/[0.04] border border-white/8 text-center",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-electric font-black text-sm",
							children: item.val
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						delay: i * 80,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "group p-6 rounded-2xl bg-white/[0.04] border border-white/8 hover:border-electric/40 hover:bg-white/[0.07] hover:-translate-y-1 transition-all duration-400 text-center h-full",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "w-14 h-14 rounded-2xl bg-electric/10 border border-electric/20 grid place-items-center mx-auto mb-4 group-hover:bg-electric group-hover:border-electric transition-all duration-300 shadow-[0_0_15px_rgba(0,150,255,0.2)]",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
										width: "22",
										height: "22",
										viewBox: "0 0 24 24",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "text-lg font-black text-white group-hover:text-electric transition-colors",
									children: c.name
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "text-xs text-white/25 mt-2 leading-relaxed",
									children: c.detail
								})
							]
						})
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-electric/15 border border-electric/30 text-xs font-semibold tracking-wider uppercase text-electric shadow-[0_0_15px_rgba(0,150,255,0.2)]",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									href: PHONE_HREF,
									className: "flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-electric/40 transition-all group shadow-[0_4px_20px_rgba(0,0,0,0.2)]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									...
									target: "_blank",
									rel: "noopener noreferrer",
									className: "flex items-center gap-4 p-5 rounded-2xl bg-[#25D366]/10 border border-[#25D366]/20 hover:bg-[#25D366]/20 hover:border-[#25D366]/40 transition-all group shadow-[0_4px_20px_rgba(0,0,0,0.2)]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "w-12 h-12 rounded-xl bg-[#25D366] grid place-items-center shrink-0 shadow-[0_0_15px_rgba(37,211,102,0.4)]",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
												width: "20",
												height: "20",
												viewBox: "0 0 24 24",
